...
control IntIngress (
    ...
    table watchlist {
        key = {
            fabric_md.lkp_md.is_ipv4  : exact   @name("ipv4_valid");
            fabric_md.lkp_md.ipv4_src : ternary @name("ipv4_src");
            fabric_md.lkp_md.ipv4_dst : ternary @name("ipv4_dst");
            fabric_md.lkp_md.ip_proto : ternary @name("ip_proto");
            fabric_md.lkp_md.l4_sport : range   @name("l4_sport");
            fabric_md.lkp_md.l4_dport : range   @name("l4_dport");
        }
        actions = {
            mark_to_report;
            no_report_collector;
