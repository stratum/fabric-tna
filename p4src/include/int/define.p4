...
const bit<16> REPORT_FIXED_HEADER_SIZE_BYTES = 12;
const bit<16> DROP_REPORT_HEADER_SIZE_BYTES = 12;
const bit<16> LOCAL_REPORT_HEADER_SIZE_BYTES = 16;
#ifdef WITH_SPGW
const bit<16> REPORT_MIRROR_HEADER_SIZE_BYTES = 24;
#else
const bit<16> REPORT_MIRROR_HEADER_SIZE_BYTES = 23;
#endif // WITH_SPGW
