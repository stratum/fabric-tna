...
enum bit<8> IntDropReason_t {
    ...
    DROP_REASON_PORT_VLAN_MAPPING_MISS = 129,
    DROP_REASON_ACL_DENY = 130,
    DROP_REASON_NEXT_ID_MISS = 131,
    DROP_REASON_BRIDGING_MISS = 132,
    DROP_REASON_MPLS_MISS = 133,
    DROP_REASON_ROUTING_V4_MISS = 134,
    DROP_REASON_ROUTING_V6_MISS = 135,
    DROP_REASON_EGRESS_NEXT_MISS = 136,
    DROP_REASON_MPLS_TTL_ZERO = 137,
    DROP_REASON_IPV4_TTL_ZERO = 138,
    DROP_REASON_IPV6_HOP_LIMIT_ZERO = 139
}
