...
control FabricDeparser(packet_out       packet,
    ...
    // bmv2 deparser should emit headers contained in egress_header if they are
    //  used within the EgressControl(). This behavior is intended to
    //  keep things as aligned as possible w.r.t. TNA implementation.
    apply {
