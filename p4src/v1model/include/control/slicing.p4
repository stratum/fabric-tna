...
control IngressQos (inout fabric_ingress_metadata_t fabric_md,
    ...
    apply {
        // Meter index should be 0 for all packets with default slice_id and tc. //Bmv2
        slice_tc_meter.execute_meter((bit<32>) fabric_md.bridged.base.slice_tc, fabric_md.packet_color);
        fabric_md.dscp = slice_tc; //FIXME

        // Meter index should be 0 for all packets with default slice_id and tc. //TNA
        set_slice_tc.apply();
