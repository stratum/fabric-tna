...
enum bit<8> IntDropReason_t {
    ...
    DROP_REASON_DOWNLINK_UE_SESSION_DROP = 133,
    DROP_REASON_UPLINK_UE_SESSION_MISS = 134,
    DROP_REASON_UPLINK_UE_SESSION_DROP = 135,
    DROP_REASON_UPLINK_UE_SESSION_DROP_BUFF = 136,
    DROP_REASON_DOWNLINK_UPF_TERMINATION_MISS = 137,
    DROP_REASON_DOWNLINK_UPF_TERMINATION_DROP = 138,
    DROP_REASON_UPLINK_UPF_TERMINATION_MISS = 139,
    DROP_REASON_UPLINK_UPF_TERMINATION_DROP = 140,
