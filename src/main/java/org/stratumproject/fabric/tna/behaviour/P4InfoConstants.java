...
public final class P4InfoConstants {
    ...
    public static final PiActionId FABRIC_EGRESS_INT_EGRESS_DO_DEFLECT_ON_DROP_REPORT_ENCAP =
            PiActionId.of("FabricEgress.int_egress.do_deflect_on_drop_report_encap");
    public static final PiActionId FABRIC_EGRESS_INT_EGRESS_DO_DEFLECT_ON_DROP_REPORT_ENCAP_MPLS =
            PiActionId.of("FabricEgress.int_egress.do_deflect_on_drop_report_encap_mpls");
