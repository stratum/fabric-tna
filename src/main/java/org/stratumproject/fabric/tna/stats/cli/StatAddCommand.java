...
/**
 * Adds fabric-tna statistics.
 */
@Service
@Command(scope = "fabric-tna", name = "stat-add", description = "Add statistics table entries")

public class StatAddCommand extends AbstractShellCommand {
    ...
    @Option(name = "-si", aliases = "--srcIp",
            description = "source IP (e.g. 192.168.1.0/24)",
    ...
    @Option(name = "-di", aliases = "--dstIp",
            description = "destination IP (e.g. 192.168.2.1/32)",
            required = false, multiValued = false)
    String dstIp = null;
    ...
    protected void doExecute() {
        ...
        statisticService.addMonitor(selector, id);
    }
}
