...
public class HighlightRemoveCommandTest extends TestCase {
    ...
    public void testDoExecute() {
        ...
        service.removeHighlight(ID, NAME, new Mod(MOD));
        EasyMock.expectLastCall().once();
        EasyMock.replay(service);

        HighlightRemoveCommand cmd = new HighlightRemoveCommand() {
            @Override
