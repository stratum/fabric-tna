...
class IntTest(IPv4UnicastTest):
    ...
    def setup_int_mirror_flow(self, switch_id, report_type=INT_REPORT_TYPE_LOCAL):
    ...
    def build_int_local_report(
        ...
        if mon_label:
            ...
            if is_device_spine:
                # MPLS label swap
                mpls_ttl -= 1
            pkt = pkt_add_mpls(pkt, label=mon_label, ttl=mpls_ttl)
        else:
    ...
    def runIntTest(
        ...
        self.setup_int_mirror_flow(switch_id)
