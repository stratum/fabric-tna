...
class IntSingleFlow(TRexTest, IntTest):
    ...
    def doRunTest(self, multiplier, pkt, is_device_spine, send_report_to_spine):
        ...
        self.trex_client.start(ports=SENDER_PORTS, mult=multiplier, duration=TMP_DURATION)
    ...
    def runTest(self):
        ...
        self.doRunTest(TMP_MULT, pkt, False, False)
