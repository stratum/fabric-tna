...
//import static org.onosproject.ngsdn.tutorial.Constants.DEFAULT_FLOW_RULE_PRIORITY;


public final class ConQuestUtils {

    private static final Logger log = LoggerFactory.getLogger(ConQuestUtils.class);
