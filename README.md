...
```text
New pipeconf registered: org.stratumproject.fabric.mavericks_sde_9_5_0 (fingerprint=...)
New pipeconf registered: org.stratumproject.fabric.montara_sde_9_5_0 (fingerprint=...)
...
```
