...
* Barefoot SDE (a.k.a. Intel P4 Studio) = 9.3.2
* ONOS >= 2.5.1
...
```text
New pipeconf registered: org.stratumproject.fabric.mavericks_sde_9_3_2 (fingerprint=...)
New pipeconf registered: org.stratumproject.fabric.montara_sde_9_3_2 (fingerprint=...)
...
```
  ...
  "devices" : {
    "device:leaf-1" : {
      ...
      "basic": {
        ...
        "pipeconf": "org.stratumproject.fabric.montara_sde_9_3_2"
      }
    }
  }
}
