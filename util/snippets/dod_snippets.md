...
```python
# Allow IPv4 packets comes from port 27/0, 28/0, 29/0, 30/0
for p in [296, 288, 272, 280]:
...
te.match['ig_port'] = '68'
te.action['port_num'] = '280' # 30/0
te.priority=1000
te.insert()

te = table_entry['FabricEgress.egress_next.egress_vlan'](action='FabricEgress.egress_next.pop_vlan')
te.match['vlan_id'] = '4094'
te.match['eg_port'] = '280' # 30/0
te.insert()
```
